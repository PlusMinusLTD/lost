...
public class OutGoingInvitationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView imageStopInvitation = findViewById(R.id.ImageRejectInvitationn);


        if (user != null) {
            if (user.getPhoto().equals("")) {
                textFirstChar.setText(user.getFullName().substring(0, 2));
                profilePicture.setVisibility(View.GONE);
                textFirstChar.setVisibility(View.VISIBLE);
            } else {
                Glide.with(OutGoingInvitationActivity.this).load(user.getPhoto()).placeholder(R.drawable.download).into(profilePicture);
        ...
        try {
            ...
            if (receivers != null && receivers.size() > 0) {
                ...
                for (int i = 0; i < receivers.size(); i++) {
                    ...
                    userNames.append(receivers.get(i).getFullName()).append(" \n");
                }
                textFirstChar.setVisibility(View.GONE);
            ...
            data.put(Constants.KEY_USERS_PHOTO, preferenceManager.getString(Constants.KEY_USERS_PHOTO));
//            data.put(User.token, preferenceManager.getString(User.token));
            ...
            public void onResponse(@NonNull Call<String> call, @NonNull Response<String> response) {
                if (response.isSuccessful()) {
                    if (type.equals(Constants.REMOTE_MSG_INVITATION)) {
                        ...
                        Toast.makeText(OutGoingInvitationActivity.this, "Reject", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                } else {
